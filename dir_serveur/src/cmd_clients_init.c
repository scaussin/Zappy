...
void		init_cmd_match_table(t_serveur *serv)
{
	...
	//serv->cmd_hdl.cmd_match_table[0].regex_match = "avance\n";
	...
	//serv->cmd_hdl.cmd_match_table[1].regex_match = "^droite\n$";
	...
	//serv->cmd_hdl.cmd_match_table[2].regex_match = "^gauche\n$";
	...
	//serv->cmd_hdl.cmd_match_table[3].regex_match = "^voir\n$";
	...
	//serv->cmd_hdl.cmd_match_table[4].regex_match = "^inventaire\n$";
	...
	//serv->cmd_hdl.cmd_match_table[5].regex_match = "^prend [a-zA-Z0-6]+\n$";
	...
	//serv->cmd_hdl.cmd_match_table[6].regex_match = "^pose [a-zA-Z0-6]+\n$";
	...
	//serv->cmd_hdl.cmd_match_table[7].regex_match = "^expulse\n$";
	...
	//serv->cmd_hdl.cmd_match_table[8].regex_match = "^broadcast [a-zA-Z0-9 ]+\n$";
	...
	//serv->cmd_hdl.cmd_match_table[9].regex_match = "^incantation\n$";
	...
	//serv->cmd_hdl.cmd_match_table[10].regex_match = "^fork\n$";
	...
	//serv->cmd_hdl.cmd_match_table[11].regex_match = "^connect_nbr\n$";
